                ...
                <div class="inputs">
                    <label>
                        <?php foreach (SEX_LIST as $key => $value) : ?>
                            <input type="radio" name="sex" id="sex" value="<?php echo htmlspecialchars($key, ENT_QUOTES, "UTF-8") ?>" <?php if (isset($values['sex']) && $key == $values['sex']) { echo 'checked'; 
} ?>><?php echo $value ?>
                        <?php endforeach ?>
                    </label>
                ...
                <div class="inputs">
                    <select name="age" id="age">
                        ...
                        <?php foreach (AGE_LIST as $key => $value) : ?>
                            <option value="<?php echo htmlspecialchars($key, ENT_QUOTES, "UTF-8") ?>" <?php if (isset($values['age']) && $key == $values['age']) { echo 'selected'; 
            ...
            <div class="item">
                ...
                <div class="inputs">
                    <?php foreach (BLOOD_LIST as $key => $value) : ?>
                        <label><input type="radio" name="blood_type" id="blood_type" value="<?php echo htmlspecialchars($key, ENT_QUOTES, "UTF-8") ?>" <?php if (isset($values['blood_type']) && $key == $values['blood_type']) { echo 'checked'; 
                ...
                <div class="inputs">
                    <select name="job" id="job">
                        ...
                        <?php foreach (JOB_LIST as $key => $value) : ?>
                            <option value="<?php echo htmlspecialchars($key, ENT_QUOTES, "UTF-8") ?>" <?php if (isset($values['job']) && $key == $values['job']) { echo 'selected'; 
} ?>><?php echo $value ?></option>
                        <?php endforeach ?>
                    </select>
                ...
                <div class="inputs">
                    <select name="address1" id="address1">
                        ...
                        <?php foreach (PREFUCTURES_LIST as $key => $value) : ?>
                            <option value="<?php echo htmlspecialchars($key, ENT_QUOTES, "UTF-8") ?>" <?php if (isset($values['address1']) && $key == $values['address1']) { echo 'selected'; 
} ?>><?php echo $value ?></option>
                        <?php endforeach ?>
                    </select>
            ...
            <div class="item">
                ...
                <div class="inputs category">
                    <?php foreach (CATEGORY_LIST as $key => $value) : ?>
                        <label><input type="checkbox" name="category[]" id="category" value="<?php echo htmlspecialchars($key, ENT_QUOTES, "UTF-8") ?>" <?php if (isset($values['category']) && is_int(array_search($key, $values['category']))) { echo 'checked';
} ?>><?php echo $value ?></label>
                    <?php endforeach ?>
