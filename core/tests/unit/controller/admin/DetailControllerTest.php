...
/**
 * @covers DetailController
 */
class DetailControllerTest extends BaseController {
    /**
     * クラス初期化
     *
     * @return void
    ...
    protected function setUp(): void
    {
        ...
        $this->instance = new DetailController(new Redirector(), new ServiceModelContainer(), new ServiceModelContainer());
    }
     ...
     * @return void
     */
    public function testIndexNoData2(): void
    {
        $this->setUpBefore(GET_QUERY_PARMATER, ADMIN_SESSION_LOGIN_ID, QUERY_STRING_NOT_EXISTS2);
        $this->assertIsArray($this->instance->index());
    }
    ...
    public function testIndexNoSessionID(): void
    {
        ...
        $this->instance = new DetailController($mockRedirector, new ServiceModelContainer(), new ServiceModelContainer());
    ...
    public function testPDOEXception(): void
    {
        ...
        $this->instance = new DetailController(new Redirector(), $container, new ServiceModelContainer());
