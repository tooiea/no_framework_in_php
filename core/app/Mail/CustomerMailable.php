...
class CustomerMailable extends BaseMailable
{
    ...
    {
        return new Envelope(
            from: new Address(config('mail.from.address'), config('mail.display_name.customer')),
            subject: config('mail.subject.customer'),
        );
    }
